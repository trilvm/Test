...
{
	var ret = true;
	var srcday = objValue.value.split("/"); 
	var descday = strValue.split("/"); 

	var date1 = new Date(srcday[2], srcday[1], srcday[0]); 
	var date2 = new Date(descday[2], descday[1], descday[0]); 
