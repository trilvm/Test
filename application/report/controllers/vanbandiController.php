...
class Report_vanbandiController extends Zend_Controller_Action{
	...
	function reportviewAction(){
		...
		$is_in = $params['is_in'];
		$this->view->data = vanbandireportModel::getReportData($fromdate,$todate,$id_svb,$sel_pb,$id_u,$is_lienThong, $id_lvbs, $sorttype);
	...
	function reportviewcvtltAction(){
		...
		if($is_in){
			...
			if($todate == "")
				$todate = "31/12";
			$this->view->thu="Từ ngày"." ".$fromdate." "."đến ngày"." ".$todate;
			$this->renderScript("vanbandi/reportviewcvtlt_in.phtml");
		}
	}
