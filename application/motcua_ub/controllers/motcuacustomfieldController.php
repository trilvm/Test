...
require_once 'motcua_ub/models/motcua_custom_fieldModel.php';

class Motcua_motcuacustomfieldController extends Zend_Controller_Action {
	...
	public function saveAction()
	{
		...
		$this->_redirect('/motcua/motcuacustomfield');
	}
	...
	public function inputAction()
	{
		...
		if($id){
			...
			$this->view->title = "Cập nhật Hồ sơ một cửa - Trường tùy biến";
		}else{
			$this->view->title = "Thêm mới Hồ sơ một cửa - Trường tùy biến";		
		}
