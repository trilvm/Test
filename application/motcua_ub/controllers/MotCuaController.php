...
require_once 'motcua_ub/models/phieu_yeucau_bosungModel.php';
require_once 'motcua_ub/models/motcua_hosoModel.php';
require_once 'hscv/models/hosocongviecModel.php';
require_once 'motcua_ub/models/LoaiModel.php';
require_once 'hscv/models/filedinhkemModel.php';
require_once 'motcua_ub/models/motcua_hosoForm.php';
require_once 'motcua_ub/models/motcua_nhangomModel.php';
require_once 'motcua_ub/models/LoaiModel.php';
require_once 'motcua_ub/models/MotCuaNhanGomModel.php';
require_once 'config/motcua.php';
require_once 'hscv/models/VanBanDuThaoModel.php';
require_once 'qtht/models/SoVanBanModel.php';
require_once 'motcua_ub/models/linhvucmotcuaModel.php';
...
class Motcua_motcuaController extends Zend_Controller_Action {
    ...
    function inputAction() {
        ...
        if ($id > 0) {
            ...
            if ($this->view->id_yeucau > 0) {
                $this->view->title = "Bổ sung hồ sơ một cửa";
    ...
    function saveAction() {
        ...
        //var_dump($formData['NHANLAI_NGAY']); exit;
        $type_id = $loaimodel->getIdLoaiHscvByIdLoai($formData["ID_LOAIHOSO"]);
        if ($type_id > 0)
            $type = $type_id;
        ...
        if ($getIdHscv == 0) {
            $getIdHscv = $hscv->CreateHSCV(
                            $formData["TRICHYEU"], 1, $type, $today, $today, Zend_Registry::get('auth')->getIdentity()->ID_U, $wf_nextuser, $formData["wf_name_user"], $formData["wf_hanxuly_user"]);
        }
        ...
        if ($formData != null) {
            try {
                ...
                //var_dump($arr_custom_fields); exit;
                ...
                if ($id > 0) {
                    ...
                    if ($formData['id_yeucau'] > 0) {
                        ...
                        try {
                            ...
                            $db->update(qlvbdhCommon::Table("wf_processlogs"), array("HANXULY" => $formData['HANXULY']), "ID_PL=" . $id_pl);
