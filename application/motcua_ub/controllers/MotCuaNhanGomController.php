...
class Motcua_MotCuaNhanGomController extends AjaxEngine 
{
	...
	public function echoHTML()
	{
		...
		if($idhoso>0)	 
		{
		 	$this->view->data_nhangom=$thutuc_them->fetchAll("ID_HOSO=".$idhoso,"TEN_THUTUC DESC");
		...
		if($idhoso==0){
		$this->view->data_input = $motcuanhangomModel->fetchAll("ID_SESSION='".$id_session."' AND ID_HOSO=0");
		}else{
			$this->view->data_nhangom=$thutuc_them->fetchAll("ID_HOSO=".$idhoso,"ID_TAILIEU_NHAN ASC");
		}
	}
	/*
	 * Ham ajax tra ket qua duoi dang html ve cho client  
